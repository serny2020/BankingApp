...
//        throw new TimeoutException(); //test on retry fallback, need to restart the account then gateway manually
        //for eureka register with new instance details
    ...
    public ResponseEntity<String> getJavaVersionFallback(Throwable throwable) {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body("Java version rate limiter fallback");
    }
